...
make_homophily_confounding_contagion_peer_figure <- function() {
  ...
  path <- here::here("figures", "dags", "homophily-confounding-contagion-peer.png")
...
make_contagion_figure <- function() {
  ...
  path <- here::here("figures", "dags", "contagion-peer.png")
